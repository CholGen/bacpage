...
def project_directory( tmp_path_factory ):
...
def test_creation_of_project_directory( project_directory ):
...
def test_creation_of_input_directory( project_directory ):
...
def test_config_file_exists( project_directory ):
...
def test_config_file_is_valid_yaml( project_directory ):
    config_file = os.path.join( project_directory, "config.yaml" )
...
def test_sample_file_exists( project_directory ):
...
def test_sample_file_is_valid_csv( project_directory ):
